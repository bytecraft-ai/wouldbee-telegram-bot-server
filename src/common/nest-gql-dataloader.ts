...
//         keys,
//         prop,
//         error = (key) => `DataLoader - ensureOrder error: Document does not exist (${key})`,
//     } = options;
...
//     protected abstract getOptions: (size?: number) => IOrderedNestDataLoaderOptions<ID, Type>;

//     public generateDataLoader() {
//         return this.createLoader(this.getOptions());
//     }

//     public generateDataLoaderWithCache(size = 250) {
//         return this.createLoader(this.getOptions(size));
//     }
...
//                 error: (keyValue) =>
//                     `DataLoader error: ${options.typeName || defaultTypeName} does not exist (${keyValue})`,
//             });
